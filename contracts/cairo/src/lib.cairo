...
trait IProofClaimContract<TContractState> {
    fn claim(ref self: TContractState, account: felt252, block: u256, ownership_slot: u256, claimer_slot: u256);
}
...
mod ProofClaimContract {
    ...
    impl ProofClaimContract of super::IProofClaimContract<ContractState> {
        fn claim(ref self: ContractState, account: felt252, block: u256, ownership_slot: u256, claimer_slot: u256) {
